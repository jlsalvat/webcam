...
You can also use **New Folder** in **VSCode**.
...
-> Copy directories includes in gcc (see precedent command in etape 10) this files are  :
	/usr/lib/gcc/x86_64-linux-gnu/7/include
 	/usr/local/include
 	/usr/lib/gcc/x86_64-linux-gnu/7/include-fixed
 	/usr/include/x86_64-linux-gnu
...
![test intellisense completion ](./easy-cpp3.jpg   "intellisense")
